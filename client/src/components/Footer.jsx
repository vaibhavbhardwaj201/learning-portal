  ...
  return (
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Column 1: About */}
        <div>
          <h3 className="text-lg font-semibold mb-4">About Learning Port</h3>
          <p className="text-gray-400">
            Learning Port is your gateway to a world of knowledge. Explore our courses, connect with experts, and enhance your skills with our interactive platform.
          </p>
        </div>
      ...
      <div className="border-t border-gray-700 mt-8 pt-4 text-center text-gray-500">
        <p>&copy; {new Date().getFullYear()} Learning Port. All rights reserved.</p>
      </div>
    </footer>
  );
};
